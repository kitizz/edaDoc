# -*- coding: utf-8 -*-
#
# EDA documentation build configuration file, created by
...
latex_documents = [
  ('index', 'EDA.tex', u'EDA Documentation',
   u'Authors', 'manual'),
]
...
texinfo_documents = [
  ('index', 'EDA', u'EDA Documentation',
   u'Authors', 'EDA', 'One line description of project.',
   'Miscellaneous'),
]
